...
function IngredientsCalculator(param) {
    let { ingredients, baseIngredient } = param;
    _s();
    ...
    const [baseQuantity, setBaseQuantity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IngredientsCalculator.useEffect": ()=>{
            const base = ingredients.find({
                "IngredientsCalculator.useEffect.base": (ing)=>ing.name.toLowerCase().includes((baseIngredient === null || baseIngredient === void 0 ? void 0 : baseIngredient.toLowerCase()) || 'farine')
            }["IngredientsCalculator.useEffect.base"]);
            if (base) {
    ...
    const formatQuantity = (quantity, unit)=>{
        if (unit === 'kg' && quantity * multiplier >= 1000) {
            return "".concat((quantity * multiplier / 1000).toFixed(2), " kg");
        }
        return "".concat((quantity * multiplier).toFixed(1), " ").concat(unit);
    };
...
_s(IngredientsCalculator, "6pZkDCz6pO4UHz1zHC3B2gm9yyY=");
...
//# sourceMappingURL=_d233b7bc._.js.map